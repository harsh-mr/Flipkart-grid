    ...
    async function listProduct(e) {
        e.preventDefault();
            ...
            data.append("upload_preset","speakingpixels")
             ...
             .then(res=>res.json())
             .then(shre=>{setproduct_image(shre.url)})
    ...
    <div className="" id="nftForm">
        ...
        <h3 className="">Upload your Product to the marketplace</h3>
            ...
            <div className="mb-6">
                ...
                <textarea className="" cols="40" rows="5" id="description" type="text" placeholder="Enter description" value={formParams.discription} onChange={e => updateFormParams({...formParams, discription: e.target.value})}></textarea>
            </div>
            <div className="mb-6">
