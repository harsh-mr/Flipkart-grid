...
import { Box, Card, Typography, Button, Grid, styled ,FormGroup, TextField} from "@mui/material";
    ...
    <>
      <Component container style={{backgroundColor:"rgb(229 232 237)"}}>
        <LeftComponent item lg={12} md={12} sm={12} xs={12}>
          <Header style={{margin: "17px",boxShadow:"box-shadow: rgba(50, 50, 93, 0.25) 0px 2px 5px -1px, rgba(0, 0, 0, 0.3) 0px 1px 3px -1px",borderRadius:" 10px 15px 15px 10px"
              }}>
          ...
          {data ? (
            data.map((item, key) => {
              return (
                <SmallComponent style={{margin: "17px",boxShadow:"box-shadow: rgba(50, 50, 93, 0.25) 0px 2px 5px -1px, rgba(0, 0, 0, 0.3) 0px 1px 3px -1px",borderRadius:" 10px 15px 15px 10px"
              }}>
                  ...
                  <Box style={{ margin: 20 }}>
                    ...
                    <Typography style={{ margin: "20px 0", overflowWrap: "break-word" }}>
                      <Description component="span" style={{overflowWrap: "break-word"}}>
                        {item.description}
                      </Description>
                      &nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;
                    </Typography>
                  ...
                  <FormGroup row style={{ margin: "10% 30px" }}>
                 <StyledTextField variant="outlined" placeholder="Receiver metamask address" />
